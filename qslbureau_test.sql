...
-- Schema qslbureau_test
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `qslbureau_test` ;
USE `qslbureau_test` ;

-- -----------------------------------------------------
-- Table `qslbureau_test`.`C_LOCAL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `qslbureau_test`.`C_LOCAL` (
...
-- -----------------------------------------------------
-- Table `qslbureau_test`.`T_SLOT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `qslbureau_test`.`T_SLOT` (
  ...
  CONSTRAINT `fk_T_SLOT_C_LOCAL1`
    FOREIGN KEY (`IDLOCAL`)
    REFERENCES `qslbureau_test`.`C_LOCAL` (`IDLOCAL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `qslbureau_test`.`C_CAPTURER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `qslbureau_test`.`C_CAPTURER` (
...
-- -----------------------------------------------------
-- Table `qslbureau_test`.`T_QSL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `qslbureau_test`.`T_QSL` (
  ...
  CONSTRAINT `fk_T_QSL_T_SLOT`
    FOREIGN KEY (`IDSLOT`)
    REFERENCES `qslbureau_test`.`T_SLOT` (`IDSLOT`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_T_QSL_C_CAPTURER1`
    FOREIGN KEY (`IDCAPTURER`)
    REFERENCES `qslbureau_test`.`C_CAPTURER` (`IDCAPTURER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `qslbureau_test`.`D_CAPTURER_LOCAL`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `qslbureau_test`.`D_CAPTURER_LOCAL` (
...
-- -----------------------------------------------------
-- Table `qslbureau_test`.`C_CALLSIGNRULE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `qslbureau_test`.`C_CALLSIGNRULE` (
...
-- -----------------------------------------------------
-- Table `qslbureau_test`.`C_ZONERULE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `qslbureau_test`.`C_ZONERULE` (
